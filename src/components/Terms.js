...
function Terms() {
  ...
  return (
    <div className="Terms">
      ...
      <p>Welcome to Nala Bheema Paakam!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of Nala Bheema Paakam's Website, located at http://localhost:3000.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Nala Bheema Paakam if you do not
      ...
      <p>
        We employ the use of cookies. By accessing Nala Bheema Paakam, you
        agreed to use cookies in agreement with the Nala Bheema Paakam's Privacy
        Policy.{" "}
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, Nala Bheema Paakam and/or its licensors own the
        intellectual property rights for all material on Nala Bheema Paakam. All
        intellectual property rights are reserved. You may access this from Nala
        Bheema Paakam for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from Nala Bheema Paakam</li>
        <li>Sell, rent or sub-license material from Nala Bheema Paakam</li>
        <li>Reproduce, duplicate or copy material from Nala Bheema Paakam</li>
        <li>Redistribute content from Nala Bheema Paakam</li>
      </ul>
      <p>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Nala
        Bheema Paakam does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Nala Bheema Paakam,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Nala Bheema Paakam
      ...
      <p>
        Nala Bheema Paakam reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant Nala Bheema Paakam a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Nala Bheema Paakam; and (d) the
      ...
      <p>
        ...
        e-mail to Nala Bheema Paakam. Please include your name, your
      ...
      <p>
        No use of Nala Bheema Paakam's logo or other artwork will be allowed for
